...
void func(struct Packet p) {
  ...
  p._br_tmp00 = !(p.pkt_3 < p.state_000);
  p._br_tmp10 = !(p.pkt_3 < p.state_000);
  p._br_tmp20 = !(p.pkt_3 < p.state_000);
  p._br_tmp30 = !(p.pkt_3 < p.state_000);
  p._br_tmp40 = p.pkt_4 == p.state_100;
  p._br_tmp11 = !(p.pkt_3 < p.state_000) && p.pkt_4 == p.state_100;
  p.state_001 = p._br_tmp11 ? (p.pkt_3) : (p.state_000);
  p._br_tmp50 = p.pkt_3 < p.state_001;
  p._br_tmp60 = p.pkt_3 < p.state_001;
  p._br_tmp70 = p.pkt_3 < p.state_001;
  p._br_tmp80 = p.pkt_3 < p.state_001;
